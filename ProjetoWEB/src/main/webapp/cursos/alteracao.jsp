...
<html><head>
    ...
    <div class="section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/Controlador" method="post">
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="inputCURSO" class="control-label">Informar o CURSO:</label>
                </div>
                <div class="col-sm-10">
                  <input type="number" name="cdcurso" class="form-control" id="inputCURSO" placeholder="Curso" required="required">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <input type="text" name="nome" class="form-control" id="inputNome" placeholder="Nome" required="required">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <input type="number" name="valor" class="form-control" id="inputVALOR" placeholder="Valor" required="required">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
                ...
                <div class="col-sm-10">
                  <input type="url" name="site" class="form-control" id="inputSITE" placeholder="Site" required="required">
                </div>
              </div>
