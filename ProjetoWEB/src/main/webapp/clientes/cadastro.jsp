          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/Controlador" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="cpf" class="form-control" id="inputEmail3" placeholder="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Digite um CPF no formato: xxx.xxx.xxx-xx" required="required">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
